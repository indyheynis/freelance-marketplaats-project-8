<x-base-layout>
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-6 flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-slate-900">Mijn reviews</h1>
                <p class="text-slate-500 text-sm mt-1">Reviews die opdrachtgevers over jou hebben achtergelaten.</p>
            </div>
        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            @empty
                <div class="px-6 py-14 text-center">
                    ...
                    <p class="text-slate-500 text-sm">Je hebt nog geen reviews ontvangen.</p>
                    <p class="text-slate-400 text-xs mt-1">Voltooi opdrachten om reviews te ontvangen van opdrachtgevers.</p>
                </div>
            @endforelse
        </div>
