...
<head>
    ...
    <title>FreelanceHub - Client Dashboard</title>
    ...
    <section class="bg-white border-b border-slate-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
            ...
            <div class="flex items-center justify-center gap-4">
                ...
                <a href="{{ route('commissions.index') }}" class="bg-white hover:bg-slate-50 text-slate-700 border border-slate-300 px-8 py-3 rounded-lg font-semibold transition-colors">
    ...
    <section class="py-16 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-slate-900 mb-3">Your Recent Commissions</h2>
                <p class="text-slate-500 text-lg">Manage your active projects and track progress</p>
            </div>
