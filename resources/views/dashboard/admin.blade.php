<x-base-layout>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="mb-8">
            ...
            <p class="text-slate-500 dark:text-slate-400 mt-1">Quick access to user, commission, review and category management.</p>
        </div>
        ...
        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            <a href="{{ route('users.index') }}" class="block bg-white dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow p-6 text-left">
                ...
                <h2 class="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-2">Manage users</h2>
                <p class="text-sm text-slate-500 dark:text-slate-400">Edit, delete, and inspect all registered users.</p>
            </a>
            ...
            <a href="{{ route('commissions.index') }}" class="block bg-white dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow p-6 text-left">
                <div class="flex items-center justify-between mb-4">
                    <span class="text-sm font-semibold text-slate-500 dark:text-slate-400">Commissions</span>
                ...
                <h2 class="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-2">Browse commissions</h2>
                <p class="text-sm text-slate-500 dark:text-slate-400">View all commissions and navigate to details.</p>
            </a>
            ...
            <a href="{{ route('reviews.index') }}" class="block bg-white dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow p-6 text-left">
                <div class="flex items-center justify-between mb-4">
                    <span class="text-sm font-semibold text-slate-500 dark:text-slate-400">Reviews</span>
                ...
                <h2 class="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-2">View reviews</h2>
                <p class="text-sm text-slate-500 dark:text-slate-400">Access review summaries and linked commissions.</p>
            </a>
            ...
            <a href="{{ route('categories.index') }}" class="block bg-white dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow p-6 text-left">
                <div class="flex items-center justify-between mb-4">
                    <span class="text-sm font-semibold text-slate-500 dark:text-slate-400">Categories</span>
                ...
                <h2 class="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-2">Manage categories</h2>
                <p class="text-sm text-slate-500 dark:text-slate-400">Create and update category options for commissions.</p>
            </a>
        </div>
    </div>
</x-base-layout>